                ...
                <div className="grid md:grid-cols-3 gap-12 max-w-4xl mx-auto mb-12">
                    ...
                    <div className="text-center md:text-left">
                        ...
                        <ul className="space-y-3 text-sm">
                            ...
                            <li><Link to="/ar-app"
                                      className="text-gray-400 hover:text-[#D37466] transition">AR-App</Link></li>
                            <li><Link to="/trackers"
                                      className="text-gray-400 hover:text-[#D37466] transition">Tracker</Link></li>
                            <li><Link to="/team" className="text-gray-400 hover:text-[#D37466] transition">Team</Link>
                            </li>
                            <li><Link to="/about" className="text-gray-400 hover:text-[#D37466] transition">About</Link>
                            </li>
                            <li><Link to="/contact"
                                      className="text-gray-400 hover:text-[#D37466] transition">Contact</Link></li>
                        </ul>
                    </div>
                    ...
                    <div className="text-center md:text-right">
                        ...
                        <div className="text-sm text-gray-400 leading-relaxed">
                            <p>
                                ...
                                <a href="mailto:onlydance.rhythm@gmail.com"
                                   className="underline hover:text-[#D37466] transition">
