function Team() {
    const members = [
        ...
        },
        {
            ...
            quote: 'Ich erschaffe den Vibe, den das Projekt ausmacht.',
            bio: 'Programmierer der Website und zuständig für das Auftreten auf Social Media. Ich bin verantwortlich, dass wir, als Team von OnlyDance, im richtigen Licht stehen.',
            color: '#D37466',
